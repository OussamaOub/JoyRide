...
function AddPost({ setisadding, post }: AddPostProps) {
  ...
  const handleSubmit = async (e: any) => {
    e.preventDefault()
    const res = await axios.post(`${apiurl}/api/posts/addpost`, newpost, {
  ...
  return (
    <div className="bg-white z-50 w-3/4 h-5/6 absolute shadow-2xl drop-shadow-2xl mobile:w-full mobile:h-screen mobile:top-0 lg:mx-4 overflow-x-hidden [&::-webkit-scrollbar]:hidden rounded-lg flex flex-col items-center py-5 overflow-y-scroll">
      <h2 className="text-2xl font-bold mt-4">Add a New Post</h2>
      <form onSubmit={handleSubmit} className="w-full max-w-sm relative">
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            value={
              newpost.departureDateTime as string | number | readonly string[]
            }
            onChange={(e) =>
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            value={newpost.arrivalDateTime as string}
            onChange={(e) =>
